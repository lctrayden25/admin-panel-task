...
import { Grid, GridItem, Text, Container, VStack, HStack, Button, Flex, Spacer, Box } from '@chakra-ui/react'
import {
  FormControl,
  FormLabel,
  FormErrorMessage,
...
const Detail = () => {
  ...
  const handleApproveSubmit = e => {
    ...
    axios({
      method: 'post',
      url: `http://localhost:5000/status/${user_id}`,
      data: {
                'status': 'Approve',
                'id': user_id
            }
                ...
                <Box colSpan={5}>
                    <Container>
                      <Flex justifyContent='space-between'>
                        <Text fontSize='xl' mb={8} textAlign='center'>User Detail</Text>
                        <Spacer />
                        <div style={{marginLeft: '20px'}}>
                          <Link to={`/admin/${user_id}`}>
                            <Button colorScheme='blue' size='sm'>Back</Button>
                          </Link>
                    ...
                    <Container>
                        ...
                        <Container>
                          <Button onClick={onOpenConfirm} colorScheme='teal' size='md' >Approve</Button>
                            ...
                            <ModalContent>
                              ...
                              <ModalFooter>
                                <form onSubmit={(e) => handleApproveSubmit(e)}>
                                  <Button colorScheme='blue' type='submit' id='approve' value='approve'>Yes</Button>
                                  <Input type='hidden' value='approve' />
                                </form>
                                <Button variant='outline' ml={3} onClick={onCloseConfirm}>Close</Button>                    
                              </ModalFooter>
                            </ModalContent>
                          </Modal>
                          
                          <Button onClick={onOpenReject} colorScheme='red' size='md' ml='4' >Reject</Button>
                            ...
                            <ModalContent>
                              ...
                              <ModalFooter>
                                <form onSubmit={(e) => handleRejectSubmit(e)}>
                                  <Button colorScheme='blue' type='submit' id='reject'>Yes</Button>
                                  <Input type='hidden' value='Reject'/>
                                </form>
                                <Button variant='outline' ml={3} onClick={onCloseReject}>Close</Button>                    
                              </ModalFooter>
                            </ModalContent>
                          </Modal> 
